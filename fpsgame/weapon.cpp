    ...
    void shoteffects(int gun, const vec &from, const vec &to, fpsent *d, bool local, int prevaction)     // create visual effect from a shot
    {
        ...
        switch(gun)
        {
            ...
            case GUN_SG:
            {
                ...
                if(muzzlelight) adddynlight(hudgunorigin(gun, d->o, to, d), 30, vec(1, 0.75f, 0.5f), 100, 100, DL_FLASH, 0, vec(0, 0, 0), d);
                break;
            }
            ...
            case GUN_PISTOL:
            {
                ...
                if(muzzlelight) adddynlight(hudgunorigin(gun, d->o, to, d), gun==GUN_CG ? 30 : 15, vec(1, 0.75f, 0.5f), gun==GUN_CG ? 50 : 100, gun==GUN_CG ? 50 : 100, DL_FLASH, 0, vec(0, 0, 0), d); 
                break;
            }
            ...
            case GUN_RIFLE: 
                ...
                if(muzzlelight) adddynlight(hudgunorigin(gun, d->o, to, d), 25, vec(1, 0.75f, 0.5f), 75, 75, DL_FLASH, 0, vec(0, 0, 0), d);
                break;
        }
